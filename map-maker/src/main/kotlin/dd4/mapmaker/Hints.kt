...
abstract class Hint(val areaId: String)

class ExitHint(areaId: String, val roomVnum: Int, val exitDirection: Direction, val type: Type) :
    Hint(areaId) {
...
class StaticHinter : Hinter {
    ...
    override fun hintsForExit(
        sourceFile: SourceFile,
        room: Room,
        exitDirection: Direction,
    ): List<ExitHint> = hints.filterIsInstance<ExitHint>()
