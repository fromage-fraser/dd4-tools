...
data class AreaRecord(val id: String, val name: String)

data class RoomRecord(val vnum: Int, val desc: String, val area: String)
...
data class ItemMobProgRecord(val level: Int, val mobile: Int, val inRoom: Int?)
